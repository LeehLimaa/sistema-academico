...
class Disciplinas_cursos(models.Model):
    ...
    semestres_disciplina_curso = models.ForeignKey(Semestres, on_delete=models.CASCADE)
    
    def __str__(self):
        return f"{self.nome_disciplina_curso}, {self.nome_disciplina_curso}, {self.curso_disciplina_curso}, {self.semestres_disciplina_curso}"
